...
Минимальное и максимальное значения около 4$ и 50 UCD соответственно, 
наиболее частая (более половины) стоимость счёта в интервале 10-23 UCD.
Количество счётов от 4$ до 10 UCD значительно меньше, чем количество от 23 до 50 UCD.
...
от стоимости счёта, на отрезке 10-25 UCD за счёт
""")
...
Значительное преобладание размера чаевых в диапазоне 1-4 S
""")
...
практически всех дней в диапазоне 16-20 UCD. Имеются выбросы максимальных значений
...
st.write("""
Сравнение размера чаевых и их количество за обед и ланч.
По обоим параметрам чаевые в обеденный промежуток превосходит
чаевые за ланч. Распределение практически одинаковое, количество чаевых
преобладает в промежутке 1-4 UCD
""")
...
Рассение между категорями относительно равномерное. 
Имеется незначительная закономерность, курящие мужщины дают чаевых
меньше (относительно размера счёта) чем некурящие.
